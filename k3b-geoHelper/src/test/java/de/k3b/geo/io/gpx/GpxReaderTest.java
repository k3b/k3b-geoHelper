...
public class GpxReaderTest {
    /** format for gpx v1.0 */
    private String xmlMinimal_gpx_v10 = "<wpt lat='53.1099972' lon='8.7178206'><name>262:3:562:54989</name><desc>type: cell, accuracy: 1640, confidence: 75</desc><url>geo:0,0?q=12.34,56.78(name)</url></wpt>\n";

    /** format for gpx v1.1 */
    private String xmlMinimal_gpx_v11 = "<trkpt lat='53.1099972' lon='8.7178206'><name>262:3:562:54989</name><desc>type: cell, accuracy: 1640, confidence: 75</desc><link href='geo:0,0?q=12.34,56.78(name)' /></trkpt>\n";
    ...
    private String xmlMinimal_gpx_v11_withNS = "<g:trkpt lat='53.1099972' lon='8.7178206'><g:name>262:3:562:54989</g:name><g:desc>type: cell, accuracy: 1640, confidence: 75</g:desc><g:link>geo:0,0?q=12.34,56.78(name)</g:link></g:trkpt>\n";
    ...
    private String xmlMinimal_kml = "<Placemark><name>262:3:562:54989</name><description>type: cell, accuracy: 1640, confidence: 75</description><Point><coordinates>8.7178206,53.1099972,0</coordinates></Point></Placemark>\n";
    ...
    public void parseFormatGpx11ShortTest() throws IOException {
        ...
        String formatted = GpxFormatter.toGpx(new StringBuilder(), location).toString();
    ...
    public void parseFormatGpx11FullTest() throws IOException {
        ...
        String formatted = GpxFormatter.toGpx(new StringBuilder(), location, location.getDescription(), location.getLink()).toString();
    ...
    public void shouldNotCrashWithEllegalCharsGpxFormatter() throws IOException {
        ...
        String xmlFragment = GpxFormatter.toGpx(new StringBuilder(), geo).toString();
